...
class ChatWindow(Window):
    ...
    def __init__(self, closeCallback: Callable[[], Any], socket: Socket, sendCallback: Callable[[Socket, tkt.Entry], None]) -> None:
        ...
        self.messageIn.bind('<Return>', lambda e: sendCallback(socket, e.widget))
        ...
        buttonQuit.bind("<FocusIn>", lambda e: e.widget.configure(fg=TEXT_COLOR, bg=ACCENT_COLOR))
        buttonQuit.bind("<FocusOut>", lambda e: e.widget.configure(fg=TEXT_COLOR_DARK, bg=PRIMARY_COLOR))
        ...
        buttonSend.bind("<FocusIn>", lambda e: e.widget.configure(fg=TEXT_COLOR, bg=ACCENT_COLOR))
        buttonSend.bind("<FocusOut>", lambda e: e.widget.configure(fg=TEXT_COLOR_DARK, bg=PRIMARY_COLOR))
